  ...
  xml.channel do
    ...
    data.builds.each do |id, info|
      xml.item do
        ...
        xml.link "https://mywarp.github.io/builds/#{info.build.number}.html"
        xml.guid "https://mywarp.github.io/builds/#{info.build.number}.html", "isPermaLink" => "true" 
      end
    end
